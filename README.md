...
There are eleven [default variables](defaults/main.yml), these should only need
changing if this role isn't run as `root`.

Documentaion for all the variables, including internal ones which you do not
need to set, are documented follow, this documentation has been generated from
the [meta/argument_specs.yml](meta/argument_specs.yml).
